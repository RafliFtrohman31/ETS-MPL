...
import '../../../../main.dart'; // Jalur import disesuaikan ke main.dart
...
class _BackgroundSyncPageState extends State<BackgroundSyncPage> {
  ...
  // Fungsi untuk membaca data dari memori internal (SharedPreferences)
  ...
  // Fungsi untuk Mendaftar Tugas Rutin ke OS
  void _mulaiSinkronisasiRutin() {
    Workmanager().registerPeriodicTask(
      "unique_id_sync_01", // ID unik tugas
      syncTask, // Nama tugas yang dicocokkan di dispatcher
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Terakhir Dikerjakan Oleh Latar Belakang:", style: TextStyle(fontSize: 14, color: Colors.grey)),
